    ...
    $.fn.fSelect = function(options) {
        ...
        if ('string' === typeof options) {
            ...
            var settings = $.extend({
                ...
                numDisplayed: 1,
                overflowText: 'Выбрано ' + '<span>' + '{n}' + '</span>',
                searchText: 'Найти',
        ...
        fSelect.prototype = {
            create: function() {
                ...
                var html = '<div class="fs-label-wrap"><div class="fs-label"></div><span class="fs-arrow"><svg width="18" height="10" viewBox="0 0 18 10" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
                    '<path d="M0.692225 0.666666C1.07457 0.298477 1.69447 0.298477 2.07682 0.666667L10.3844 8.66666L8.99978 10L0.692226 2C0.309881 1.63181 0.30988 1.03486 0.692225 0.666666Z" fill="#262C40"/>\n' +
                    '<path d="M7.61548 8.66675L15.923 0.666753C16.3054 0.298563 16.9253 0.298562 17.3076 0.666752C17.69 1.03494 17.69 1.63189 17.3076 2.00008L9.00007 10.0001L7.61548 8.66675Z" fill="#262C40"/>\n' +
                    '</svg>\n</span></div>';
